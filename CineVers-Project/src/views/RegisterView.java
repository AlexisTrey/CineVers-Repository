...
public class RegisterView extends JPanel {
    ...
    public RegisterView() {
        ...
        formPanel.setPreferredSize(new Dimension(700, 900));
...
lblTitulo.setBorder(new EmptyBorder(40, 0, 60, 0)); 
        ...
        btnRegistrar.setPreferredSize(new Dimension(300, 55));
 ...
 *  public static void main(String[] args) {
        JFrame frame = new JFrame("CineVers - Registro");
        ...
        scrollPane.getViewport().setBackground(new Color(20, 0, 40));
